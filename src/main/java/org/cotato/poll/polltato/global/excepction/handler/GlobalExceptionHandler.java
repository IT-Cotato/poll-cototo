package org.cotato.poll.polltato.global.excepction.handler;

import java.util.List;

import org.cotato.poll.polltato.global.excepction.ErrorCode;
import org.cotato.poll.polltato.global.response.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleEntityNotFoundException(EntityNotFoundException exception,
		...
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
			.body(ErrorResponse.of(ErrorCode.ENTITY_NOT_FOUND, List.of(exception.getMessage())));
	}
	...
	public ResponseEntity<ErrorResponse> handleException(Exception exception) {
		...
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
			.body(ErrorResponse.from(ErrorCode.UNEXPECTED_EXCEPTION));
	}
}
